import { GET_POOLS, GET_SWIMMERS, GET_SIZE, GET_SIZES, UPDATE_SIZE_ACTION, GET_ITEMS, SET_SWIMMER, COMPLETE_FORM, EDIT_FORM } from "../types";
...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case EDIT_FORM:
      return {...state, editForm: true, formComplete: false}
